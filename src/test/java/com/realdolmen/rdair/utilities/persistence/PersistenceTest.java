package com.realdolmen.rdAir.utilities.persistence;
...
public abstract class PersistenceTest extends Assert {
     ...
     * Default lets {@link com.realdolmen.rdAir.utilities.persistence.PersistenceTest.DatabaseEngine#current()} choose.
     ...
     * Note this connection does not participate in the same transaction as the {@link com.realdolmen.rdAir.utilities.persistence.JpaPersistenceTest#entityManager()}, so be careful
    ...
    public enum DatabaseEngine {
        ...
        private static final String DATABASE_SCHEMA_NAME = "rdairdb";
